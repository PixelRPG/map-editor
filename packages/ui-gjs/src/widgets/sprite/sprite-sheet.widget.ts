...
export class SpriteSheetWidget extends Gtk.ScrolledWindow {
  ...
  // GObject properties
  declare _spriteSheet: SpriteSheetResource
  ...
  static {
    GObject.registerClass({
      ...
      Properties: {
        spriteSheet: Object.ParamSpec.object('spriteSheet', 'SpriteSheet', 'SpriteSheet', GObject.ParamFlags.READWRITE as any, SpriteSheetResource),
      },
    }, this);
  }
  constructor(spriteSheetObject: SpriteSheetResource) {
