...
export class SpriteMockData {
    ...
    static createSolidSprite(
        width: number, 
        height: number, 
        color: readonly [number, number, number, number] = SpriteMockData.COLORS.RED
    ): SpriteResource {
    ...
    static createCheckerboardSprite(
        width: number, 
        height: number,
        color1: readonly [number, number, number, number] = SpriteMockData.COLORS.BLACK,
        color2: readonly [number, number, number, number] = SpriteMockData.COLORS.WHITE,
        checkSize: number = 4
    ): SpriteResource {
        const texture = SpriteMockData.createCheckerboardTexture(width, height, color1, color2, checkSize);
        return SpriteResource.fromTexture(texture);
    }
    ...
    static createStripedSprite(
        width: number, 
        height: number,
        color1: readonly [number, number, number, number] = SpriteMockData.COLORS.RED,
        color2: readonly [number, number, number, number] = SpriteMockData.COLORS.BLUE,
        stripeSize: number = 4,
        horizontal: boolean = true
    ): SpriteResource {
        const texture = SpriteMockData.createStripedTexture(width, height, color1, color2, stripeSize, horizontal);
        return SpriteResource.fromTexture(texture);
    }
    ...
    static createGradientSprite(
        width: number, 
        height: number,
        startColor: readonly [number, number, number, number] = SpriteMockData.COLORS.RED,
        endColor: readonly [number, number, number, number] = SpriteMockData.COLORS.BLUE,
        horizontal: boolean = true
    ): SpriteResource {
        const texture = SpriteMockData.createGradientTexture(width, height, startColor, endColor, horizontal);
        return SpriteResource.fromTexture(texture);
    }
    ...
    static createBorderSprite(
        width: number, 
        height: number,
        fillColor: readonly [number, number, number, number] = SpriteMockData.COLORS.WHITE,
        borderColor: readonly [number, number, number, number] = SpriteMockData.COLORS.BLACK,
        borderWidth: number = 1
    ): SpriteResource {
        const texture = SpriteMockData.createBorderTexture(width, height, fillColor, borderColor, borderWidth);
        return SpriteResource.fromTexture(texture);
    }

    /**
     * Create a sprite based on pattern name and configuration (texture-based)
     */
    static createSprite(
        width: number,
        height: number,
        ...
        const color1 = SpriteMockData.COLORS[primaryColor]
        const color2 = SpriteMockData.COLORS[secondaryColor]

        // All patterns now use direct texture creation
        let texture: Gdk.Texture;

        switch (pattern) {
            case 'SOLID':
                texture = SpriteMockData.createSolidTexture(width, height, color1);
                break;
            case 'CHECKERBOARD':
                texture = SpriteMockData.createCheckerboardTexture(width, height, color1, color2);
                break;
            case 'STRIPES_H':
                texture = SpriteMockData.createStripedTexture(width, height, color1, color2, 4, true);
                break;
            case 'STRIPES_V':
                texture = SpriteMockData.createStripedTexture(width, height, color1, color2, 4, false);
                break;
            case 'GRADIENT':
                texture = SpriteMockData.createGradientTexture(width, height, color1, color2, true);
                break;
            case 'BORDER':
                texture = SpriteMockData.createBorderTexture(width, height, color1, color2);
                break;
            default:
                texture = SpriteMockData.createSolidTexture(width, height, color1);
                break;
    ...
    static createSolidTexture(
        ...
        return SpriteMockData.createTextureFromPixels(actualWidth, actualHeight, pixels)
    }
    ...
    static createSpriteOptimized(
        ...
        return SpriteMockData.createSprite(width, height, pattern, primaryColor, secondaryColor);
    }
