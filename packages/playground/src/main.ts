...
export const TestApplication = GObject.registerClass(class TestApplication extends Adw.Application {
    constructor() {
        super({applicationId: 'org.gnome.Example', flags: Gio.ApplicationFlags.DEFAULT_FLAGS});
