...
/**
 * Response message for RPC communication (wire format)
 */
export interface WireRpcResponse extends RpcMessage {
  type: 'response'
 ...
 */
export type RpcMessageType = RpcRequest | WireRpcResponse
