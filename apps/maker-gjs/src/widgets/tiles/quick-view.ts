...
/**
 * The Sheets view's desktop quick-view sidebar — one read-only glance
    ...
    GObject.registerClass(
      {
        ...
        Template,
        InternalChildren: ['stack', 'preview_stack', 'thumb', 'preview', 'name_label', 'subtitle_label', 'edit_button'],
        Signals: {
